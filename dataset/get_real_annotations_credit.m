function [f,F,TestSet] = get_real_annotations_credit(Data,K,M,p_vec,p_block)



[TrainSet,TestSet]=getRandomTrainSet(Data);
N=size(TestSet,1);
[Model1, validationAccuracy1]=trainClassifier0Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
[Model2, validationAccuracy2]=trainClassifier1Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
[Model3, validationAccuracy3]=trainClassifier2Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
[Model4, validationAccuracy4]=trainClassifier3Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
 [Model5, validationAccuracy5]=trainClassifier4Credit(TrainSet);
%  TrainSet=getRandomTrainSet(Data);
 [Model6, validationAccuracy6]=trainClassifier11Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
 [Model7, validationAccuracy7]=trainClassifier6Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
 [Model8, validationAccuracy8]=trainClassifier9Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
 [Model9, validationAccuracy9]=trainClassifier7Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
  [Model10, validationAccuracy10]=trainClassifier8Credit(TrainSet);
% TrainSet=getRandomTrainSet(Data);
