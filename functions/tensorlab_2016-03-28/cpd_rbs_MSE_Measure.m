function [U, output] = cpd_rbs_MSE_Measure(T, U, A, varargin)
...
%   - 2014/06/12   NV      Initial version
    ...
    p.addOptional('BlockSize', ones(1, N)*20);
    ...
    while ~output.info
        ...
        if mod(k,md)==0
            ...
            MSE_A(k1+1) = (1/3)*(MSE_measure( U{1},A{1}) + MSE_measure( U{2},A{2}) + MSE_measure( U{3},A{3}));
