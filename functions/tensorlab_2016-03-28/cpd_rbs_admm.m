function [U, output] = cpd_rbs_admm(T, U, varargin)
...
%   - 2014/06/12   NV      Initial version
    ...
    p.addOptional('Algorithm', @AOadmm_xiao);
    ...
    NRE_A(1) = err_e/len;
    disp(['RBS at iteration ',num2str(1),' and the COST is ',num2str(NRE_A(1))])
    ...
    while ~output.info
        ...
        if useexternalroutines
            ...
            [Us, out] = options.Algorithm(XX, k_admm, ops,XX);
        end 
